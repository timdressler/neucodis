...
save(fullfile(OUTPATH, '_fooof_analysis_plot_data.mat'), 'orignial_freq_GRANDAVERAGE', ...
    ...
    'oscillatory_freq_GRANDAVERAGE', 'oscillatory_alt_powspctrm_GRANDAVERAGE', ...
    'oscillatory_powspctrm_GRANDAVERAGE', 'oscillatory_alt_freq_GRANDAVERAGE', ... 
    'oscillatory_alt_powspctrm_GRANDAVERAGE');
