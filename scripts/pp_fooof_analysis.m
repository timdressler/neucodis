...
save(fullfile(OUTPATH, '_fooof_analysis_plot_data.mat'), 'orignial_freq_GRANDAVERAGE', 'original_powspctrm_GRANDAVERAGE', 'fractal_freq_GRANDAVERAGE', 'fractal_powspctrm_GRANDAVERAGE', 'oscillatory_freq_GRANDAVERAGE', 'oscillatory_alt_powspctrm_GRANDAVERAGE');
